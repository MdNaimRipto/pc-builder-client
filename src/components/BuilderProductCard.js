  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <button
          onClick={() => {
            setBuilderProduct([...builderProduct, products]);
            router.push("/pc-builder");
          }}
          className="hover-effects bg-blue-600 w-[95%] py-3 mx-auto font-bold font-sans text-white rounded flex items-center justify-center"
        >
